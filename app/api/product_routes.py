...
def get_products():
    ...
    response = requests.get(f"https://openapi.etsy.com/v2/listings/active/?api_key=h6jf3au38z1loqmhogom8cet&limit=50&includes=MainImage&keywords=Dungeons%20and%20dragons")
